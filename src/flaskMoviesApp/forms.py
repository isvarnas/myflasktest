...
class NewMovieForm(FlaskForm):
    ...
    movie_release_year = IntegerField(label='Έτος Πρώτης Προβολής',
                                      validators=[Optional(strip_whitespace=True),
                                                  NumberRange(min=1888, max=current_year, message=f"Το έτος πρώτης προβολής πρέπει να παίρνει τιμές από 1888 έως {current_year}.")])
    ...
    movie_rating = IntegerField(label='Βαθμολογία Ταινίας',
                                      validators=[DataRequired(message="Αυτό το πεδίο δε μπορεί να είναι κενό."),
                                                  NumberRange(min=1, max=100, message="Η βαθμολογία πρέπει να παίρνει τιμές από 1 έως 100.")])
